...
namespace User_Mangement.Controllers
{
    public class AuthController (UserAuthDbContext db,IConfiguration configuration) : Controller
    {
        ...
        public IActionResult LoginUser(UserLoginDTO obj)
        {
            ...
            {
                ModelState.AddModelError("EmailId", "this is required field");
                return View(obj);
            }
            ...
            if (user == null)
            {
                ModelState.AddModelError("Password", "Either Email or password is wrong");
                return View(obj);
            }
            ...
            if (!verified)
            {
                ModelState.AddModelError("EmailId", "Either Email or password is wrong");
                return View(obj);
            }
